...
# =========================
# ADD WORKOUT ENTRY (USING STORED PROCEDURE)
# =========================
...
def add_entry(session_id):
    ...
    if request.method == "POST":
        ...
        try:
            ...
            cursor.callproc(
                "AddWorkoutEntry",
                [session_id, exercise_id, set_number, reps, weight, rest_seconds, 0, ""]
            )
            ...
            # Check the procedure's success output
    ...
    return render_template("add_entry.html", exercises=exercises, session_id=session_id, message=message)
...
def measurements():
    ...
    if request.method == "POST":
        ...
        try:
            ...
            # The trigger will catch invalid data
